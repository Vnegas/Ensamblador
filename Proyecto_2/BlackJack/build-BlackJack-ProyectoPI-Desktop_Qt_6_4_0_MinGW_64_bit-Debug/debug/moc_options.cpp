...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Options_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Options_t qt_meta_stringdata_Options = {
    {
        QT_MOC_LITERAL(0, 7),  // "Options"
        QT_MOC_LITERAL(8, 20),  // "on_OnePlayer_clicked"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 21)   // "on_TwoPlayers_clicked"
    },
    "Options",
...
Q_CONSTINIT static const uint qt_meta_data_Options[] = {
...
Q_CONSTINIT const QMetaObject Options::staticMetaObject = { {
    ...
    qt_meta_stringdata_Options.offsetsAndSizes,
    qt_meta_data_Options,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Options_t,
        // Q_OBJECT / Q_GADGET
...
void Options::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_OnePlayer_clicked(); break;
        case 1: _t->on_TwoPlayers_clicked(); break;
        default: ;
        }
    }
    (void)_a;
