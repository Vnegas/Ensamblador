...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_rules_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_rules_t qt_meta_stringdata_rules = {
    {
        QT_MOC_LITERAL(0, 5),  // "rules"
        QT_MOC_LITERAL(6, 16),  // "on_Salir_clicked"
        QT_MOC_LITERAL(23, 0)   // ""
    },
    "rules",
    "on_Salir_clicked",
...
Q_CONSTINIT static const uint qt_meta_data_rules[] = {
...
Q_CONSTINIT const QMetaObject rules::staticMetaObject = { {
    ...
    qt_meta_stringdata_rules.offsetsAndSizes,
    qt_meta_data_rules,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_rules_t,
        // Q_OBJECT / Q_GADGET
